// Generated from C:/Users/Usuario/Desktop/DLP/ExamenDLP/AST_SwitchCase/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_switchStmt = 12, RULE_switchCase = 13, RULE_block = 14, RULE_expression = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"statement", "switchStmt", "switchCase", "block", "expression"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'log'", "'input'", "'='", "'if'", "'else'", "'while'", "'return'", "'switch'", 
			"'default'", "'case'", "'.'", "'as'", "'-'", "'!'", "'*'", "'/'", "'%'", 
			"'+'", "'>'", "'>='", "'<'", "'<='", "'!='", "'=='", "'&&'", "'||'"
		};
	}
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 527767222747200L) != 0)) {
				{
				{
				setState(114);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				{
				setState(248);
				((StatementContext)_localctx).sw = switchStmt();
	...
	public static class SwitchStmtContext extends ParserRuleContext {
		...
		public List<Statement> defaultBody = new ArrayList<>();
		public ExpressionContext e1;
		public SwitchCaseContext c;
		public StatementContext s;
	...
	public final SwitchStmtContext switchStmt() throws RecognitionException {
		...
		try {
			...
			match(T__5);
			setState(255);
			((SwitchStmtContext)_localctx).e1 = expression(0);
			setState(256);
			match(T__6);
			setState(257);
			match(T__8);
			...
			while (_la==T__25) {
				...
				{
				setState(258);
				((SwitchStmtContext)_localctx).c = switchCase();
				 _localctx.cases.add(((SwitchStmtContext)_localctx).c.ast); 
				}
				}
				setState(265);
				_errHandler.sync(this);
			...
			if (_la==T__24) {
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 527767222747200L) != 0)) {
					...
					{
					setState(268);
					((SwitchStmtContext)_localctx).s = statement();
					 _localctx.defaultBody.addAll(((SwitchStmtContext)_localctx).s.ast); 
					}
					}
					setState(275);
					_errHandler.sync(this);
			...
			setState(278);
			match(T__9);
			 ((SwitchStmtContext)_localctx).ast =  new Switch(((SwitchStmtContext)_localctx).e1.ast,
			                                  _localctx.cases,
			                                  _localctx.defaultBody,
			                                  ((SwitchStmtContext)_localctx).e1.ast.getLine(),
			                                  ((SwitchStmtContext)_localctx).e1.ast.getColumn()); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SwitchCaseContext switchCase() throws RecognitionException {
		...
		try {
			...
			match(T__25);
			setState(282);
			((SwitchCaseContext)_localctx).e1 = expression(0);
			setState(283);
			match(T__1);
			setState(289);
			_errHandler.sync(this);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 527767222747200L) != 0)) {
				...
				{
				setState(284);
				((SwitchCaseContext)_localctx).s = statement();
				 _localctx.body.addAll(((SwitchCaseContext)_localctx).s.ast); 
				}
				}
				setState(291);
				_errHandler.sync(this);
			 ...
			 ((SwitchCaseContext)_localctx).ast =  new SwitchCase(((SwitchCaseContext)_localctx).e1.ast,
			                                      _localctx.body,
			                                      ((SwitchCaseContext)_localctx).e1.ast.getLine(),
			                                      ((SwitchCaseContext)_localctx).e1.ast.getColumn()); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\u0001\u000b\u0001\u000b\u0001\u000b\u0003\u000b\u00fc\b\u000b\u0001\f"+
		"\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0005\f\u0106"+
		"\b\f\n\f\f\f\u0109\t\f\u0001\f\u0001\f\u0001\f\u0001\f\u0001\f\u0005\f"+
		"\u0110\b\f\n\f\f\f\u0113\t\f\u0003\f\u0115\b\f\u0001\f\u0001\f\u0001\f"+
		"\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0001\r\u0005\r\u0120\b\r\n\r"+
		"\f\r\u0123\t\r\u0001\r\u0001\r\u0001\u000e\u0001\u000e\u0001\u000e\u0001"+
		"\u000e\u0001\u000e\u0001\u000e\u0001\u000e\u0004\u000e\u012e\b\u000e\u000b"+
		"\u000e\f\u000e\u012f\u0001\u000e\u0001\u000e\u0003\u000e\u0134\b\u000e"+
