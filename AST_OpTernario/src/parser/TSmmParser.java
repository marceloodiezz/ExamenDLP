// Generated from C:/Users/Usuario/Desktop/DLP/ExamenDLP/AST_OpTernario/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941610684480L) != 0)) {
				{
				{
				setState(110);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941596659776L) != 0)) {
					{
					setState(197);
					((StatementContext)_localctx).e1 = expression(0);
				...
				if ( _alt==1 ) {
					...
					case 5:
						...
						((ExpressionContext)_localctx).e3 = expression(5);
						 ((ExpressionContext)_localctx).ast =  new TernaryOp(((ExpressionContext)_localctx).e1.ast,
						                                               ((ExpressionContext)_localctx).e2.ast,
