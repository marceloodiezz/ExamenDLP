...
public class NumberType extends AbstractType {
    ...
    public Type ternary(Type other, Locatable l) {
        if (other == CharType.getInstance() || other == IntType.getInstance() || other == NumberType.getInstance())
            return NumberType.getInstance();
        return super.ternary(other, l);
    }
    ...
    public Type canBeCastTo(Type t, Locatable l) {
        if(t == IntType.getInstance() || t == NumberType.getInstance() || t == CharType.getInstance())
            return t;
