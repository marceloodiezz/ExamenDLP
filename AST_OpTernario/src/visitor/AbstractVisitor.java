...
public abstract class AbstractVisitor<RT, PT> implements Visitor<RT, PT> {
    ...
    @Override
    public RT visit(TernaryOp ternaryOp, PT param) {
        ternaryOp.getCondition().accept(this, param);
        ternaryOp.getExprTrue().accept(this, param);
        ternaryOp.getExprFalse().accept(this, param);
        return null;
    }
