// Generated from C:/Users/Usuario/Desktop/DLP/ExamenDLP/AST_ForEach/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, WHITE=42, COMMENTS=43, REAL_CONSTANT=44, 
		INT_CONSTANT=45, CHAR_CONSTANT=46, ID=47;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'log'", "'input'", "'='", "'if'", "'else'", "'while'", "'return'", "'foreach'", 
			"'in'", "'.'", "'as'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'>'", 
			"'>='", "'<'", "'<='", "'!='", "'=='", "'&&'", "'||'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "WHITE", "COMMENTS", "REAL_CONSTANT", 
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263883626774592L) != 0)) {
				{
				{
				setState(110);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263883595972672L) != 0)) {
					{
					setState(197);
					((StatementContext)_localctx).e1 = expression(0);
			...
			case 8:
				...
				((StatementContext)_localctx).b1 = block();
				                 ...
				                 Variable iterator = new Variable(((StatementContext)_localctx).ID.getText(),
				                                                  ((StatementContext)_localctx).ID.getLine(),
				                                                  ((StatementContext)_localctx).ID.getCharPositionInLine()+1);
				                 _localctx.ast.add(new ForEach(iterator,
